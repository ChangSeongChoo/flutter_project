...
class AppRoutes {
  ...
  // static const nfcReaderPage = '/nfc-reader-page';
  // static const nfcWriterPage = '/nfc-writer-page';
  ...
  static Route<dynamic>? onGenerateRoute(
    ...
    switch (settings.name) {
      case AppRoutes.emailPasswordSignInPage:
        ...
        //NFC readerPageRoute
      // case AppRoutes.nfcReaderPage:
      //   return MaterialPageRoute<dynamic>(
      //     builder: (_) => NfcReaderPage(),
      //     settings: settings,
      //     fullscreenDialog: true,
      //   );
      // case AppRoutes.nfcWriterPage:
      //   return MaterialPageRoute<dynamic>(
      //     builder: (_) => NfcWriterPage(),
      //     settings: settings,
      //     fullscreenDialog: true,
      //   );
